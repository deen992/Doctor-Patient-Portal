...
<nav class="navbar navbar-expand-lg navbar-dark"style="background-color: #800080;">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-sharp fa-solid fa-hospital"></i> ICEPS Health Portal</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj}">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="user_appointment.jsp"><i class=""></i></a></li>
					<li class="nav-item"><a class="nav-link active"
				...
				<c:if test="${not empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="user_appointment.jsp"><i class="fa fa-book fa-1x"></i> MAKE APPOINTMENT</a></li>
					<li class="nav-item"><a class="nav-link active"
