...
<body>
	...
	<div class="container p-5">
                ...
                <p class="text-center fs-1" style="color: #6f42c1;"> Dashboard</p>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="card my-card">
					<div class="card-body text-center fs-5"style="color: #800080;">
  ...
  <a href="doctor.jsp" class="text-decoration-none">
    <div class="card my-card" data-bs-toggle="modal" data-bs-target="#exampleModal">
      <div class="card-body text-center fs-5" style="color: #800080;">
        ...
        <p class="fs-4 text-center">
          Add Doctor <br><%= totalNumberOfDoctor %>
        </p>
      </div>
    </div>
  </a>
                        ...
                        <div class="col-md-4 mt-4">
                            <a href="admin_change_password.jsp" class="text-decoration-none">
				<div class="card my-card" data-bs-toggle="modal"
					data-bs-target="#exampleModal">
					<div class="card-body text-center fs-5"style="color: #800080;">
						<i class="fa-solid fa-cog fa-3x"></i><br>
						<p class="fs-4 text-center">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title " style="color: #800080;" id="exampleModalLabel">Add Specialist</h5>
